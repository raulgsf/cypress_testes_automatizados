/*describe('Vendedor - Deve ser capaz de adicionar, remover e alterar filtros na página Financeiro', () => {
    ...
    it('Deve adicionar, remover e alterar um filtro', () => {
        ...
        let coluna = Cypress.env('colunaFiltroMeusPedidos')
        let condicao = Cypress.env('condicaoFiltroMeusPedidos')
        let valorFiltro = Cypress.env('valorFiltroMeusPedidos')
        let numeroUnico = Cypress.env('valorNumeroUnicoMeusPedidosComparacao')
        let dataComparacao = Cypress.env('dataVencimentoMeusPedidosComparacao')
        let numeroNota = Cypress.env('valorNumeroNotaMeusPedidosComparacao')
        ...
        if(condicao == 'Vazio'){
            ...
            }else if(coluna == 'Vlr. Nota'){
                cy.get('div.css-1wczjc0').click()
                cy.get('div[data-colindex = 1]').then(numeros => {
                    cy.get(numeros).should('have.length', 1)
                })
            }
